...
class Aomp_Dao_Recordset implements Countable, Iterator
{
     ...
     * @var string
     */
    protected $_recordClass = 'Aomp_Dao_Record';
    ...
    /**
     * Collection of instantiated Aomp_Dao_Record objects.
     *
     * @var array
     */
    ...
    public function __construct(array $data = array(), $config = null)
    {
        ...
        if (is_array($config)) {
            ...
            if (null !== $exception) {
                ...
                throw new Aomp_Dao_Exception($exception);
            }
        ...
        if (!class_exists($this->_recordClass)) {
            require_once 'Aomp/Dao/Record.php';
        }
    ...
    public function toArray($indexColumn = null)
    {
        ...
        while ($this->valid()) {
            $record = $this->current();
            if ($record instanceof Aomp_Dao_Record) {
