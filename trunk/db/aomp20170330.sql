...
) ENGINE=MyISAM AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='组权限';
...
INSERT INTO `group_power` VALUES (24,1,6,7,'2017-03-30 07:02:09'),(23,1,5,7,'2017-03-30 07:02:09'),(3,2,1,4,'2017-03-28 09:10:49'),(4,2,2,7,'2017-03-28 09:10:49'),(5,2,3,7,'2017-03-28 09:10:49'),(22,1,4,7,'2017-03-30 07:02:09'),(21,1,3,7,'2017-03-30 07:02:09'),(20,1,2,7,'2017-03-30 07:02:09'),(19,1,1,7,'2017-03-30 07:02:09'),(25,1,7,7,'2017-03-30 07:02:09');
...
INSERT INTO `power` VALUES (1,'权限表管理','power',0,'2017-03-24 02:49:17'),(2,'组管理','group',1,'2017-03-24 07:35:10'),(3,'服务器列表','index',10,'2017-03-28 08:52:05'),(4,'管理员中心','user',2,'2017-03-28 09:29:34'),(5,'数据库','db',4,'2017-03-30 06:16:31'),(6,'数据库日志','dblog',4,'2017-03-30 06:19:48'),(7,'类型','type',3,'2017-03-30 07:01:23');
...
CREATE TABLE `remote_type` (
  ...
  `CreateTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='主机类型表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `remote_type` VALUES (1,1,'Mysql','2017-03-30 09:44:47');
...
-- Dump completed on 2017-03-30 18:09:10
