...
INSERT INTO `group_power` VALUES (3,2,1,4,'2017-03-28 17:10:49'),(4,2,2,7,'2017-03-28 17:10:49'),(5,2,3,7,'2017-03-28 17:10:49'),(33,1,1,7,'2017-03-31 10:10:57'),(34,1,2,7,'2017-03-31 10:10:57'),(35,1,3,7,'2017-03-31 10:10:57'),(36,1,4,7,'2017-03-31 10:10:57'),(37,1,5,7,'2017-03-31 10:10:57'),(38,1,6,7,'2017-03-31 10:10:57'),(39,1,7,7,'2017-03-31 10:10:57');
...
INSERT INTO `power` VALUES (1,'权限表管理','power',0,'2017-03-24 10:49:17'),(2,'组管理','group',1,'2017-03-24 15:35:10'),(3,'服务器列表','index',10,'2017-03-28 16:52:05'),(4,'管理员中心','user',2,'2017-03-28 17:29:34'),(5,'数据库','db',5,'2017-03-30 14:16:31'),(6,'数据库日志','dblog',4,'2017-03-30 14:19:48'),(7,'类型','type',3,'2017-03-30 15:01:23');
...
CREATE TABLE `remote` (
  ...
  KEY `idx_UserID` (`UserID`),
  KEY `idx_IP` (`IP`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='主机表';
...
INSERT INTO `remote` VALUES (1,2,1,'本地开发环境',3232262784,0,'2017-03-31 14:37:14');
...
CREATE TABLE `remote_dba` (
  `ID` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `RemoteID` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '主机ID',
  `TypeID` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '数据库类型',
...
INSERT INTO `remote_type` VALUES (1,1,'mysql','2017-03-30 17:44:47'),(2,1,'centos','2017-03-31 09:28:46');
...
INSERT INTO `user_group` VALUES (1,'自动化运维组','2017-03-27 17:16:28'),(2,'运维组','2017-03-28 13:53:43'),(3,'测试组','2017-03-28 14:13:13'),(5,'开发组','2017-03-28 14:23:49'),(6,'管理组','2017-03-28 14:24:26');
